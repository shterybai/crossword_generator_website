...
css_file = [r"C:\Users\andre\Documents\GitHub\crossword_generator_website\static\css\bootstrap.css"]
js_file = r"C:\Users\andre\Documents\GitHub\crossword_generator_website\static\js\bootstrap.js"
...
def create_empty_pdf():
    ...
    path_wkhtmltopdf = r'C:\Program Files\wkhtmltopdf\bin\wkhtmltopdf.exe'
    config = pdfkit.configuration(wkhtmltopdf=path_wkhtmltopdf)
    pdf = pdfkit.from_string(rendered, False, configuration=config, options={"enable-local-file-access": ""}, css=css_file)
